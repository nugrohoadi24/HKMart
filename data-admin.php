...
<head>
  ...
  <title>Husnul Khatimah - Data Admin</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Data Admin Pengelola Website Skirpsi - Husnul Khatimah</a>.</p>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                        foreach($tampil_admin as $tampil_admin_value =>$tampil_admin_final){

                        ?>
                    <tr>
                      <td><?php  echo $tampil_admin_final['NAMA']; ?></td>
                      <td><?php  echo $tampil_admin_final['ID']; ?></td>
                      <td><?php  echo $tampil_admin_final['EMAIL']; ?></td>
                        <?php } ?>
                  </tbody>
                </table>
              </div>
